...
/*   Updated: 2024/02/21 00:38:18 by picatrai         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_token_part_2(t_data_parse *data_parse, t_token **token)
{
	...
	if (data_parse->index != 0)
	{
		...
		if (data_parse->input[data_parse->index - 1] != ' ' && data_parse->input[data_parse->index - 1] != '"' && data_parse->input[data_parse->index - 1] != '\'')
			data_parse->merge = 1;
	}
